...
const defaultTelegramData = {
  ...
  role_id: 1,
  stage_id: 1,
  court_name: 'Бостандыкский районный суд города Алматы',
  court_address: 'город Алматы',
  case_number: '№7514-25-00-2/13300',
  price_of_claim: `788 618 (семьсот восемьдесят восемь тысяч шестьсот восемь) тенге`,
  userData: {
    fullName: 'ТОО Ди-Мобилити Казахстан',
    bin: '7567657567',
  ...
  opponentData: {
    fullName: 'Личадеев Александр Владимирович',
    iin: '4321',
    address: 'город Алматы',
    phone: '222222',
  ...
  async generateDocumentFromSituation(
    ...
    try {
      ...
      const prompt = `
        ...
        ПОСЛЕ ЗАВЕРШЕНИЯ ГЕНЕРАЦИИ ДОКУМЕНТА УДАЛИТЬ СТРОЧКИ:
